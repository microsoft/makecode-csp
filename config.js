const config = {
  ...
  sidebar: {
    ...
    links: [{ text: 'MakeCode', link: 'https://makecode.com' }],
    frontline: false,
    ignoreIndex: true,
    title:
      "Contents",
  ...
  siteMetadata: {
    ...
    description: 'Microsoft MakeCode Advanced Placement Computer Science Principles Curriculum',
    ogImage: null,
    docsLocation: 'https://github.com/microsoft/makecode-csp/tree/master/content',
