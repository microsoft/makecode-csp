...
All of the materials for the **AP Computer Science Principles with Microsoft MakeCode** course are available to download. You must be a verified educator to download the course materials. Please create a GitHub Educator account, see the instructions [here](https://makecode.com/github-teacher-verification).
